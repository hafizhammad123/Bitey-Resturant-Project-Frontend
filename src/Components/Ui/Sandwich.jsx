...
import dealsImage from "../../assets/Images/1x/sandwich.jpg";
...
export default function SandWich() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/sandwichItem/detail/${id}`)
    ...
    const getSandwichItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/sandwichItem/get`)
