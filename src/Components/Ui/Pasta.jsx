...
import dealsImage from "../../assets/Images/1x/Pasta-01-01.jpg";
...
export default function Pasta() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/pastaItem/detail/${id}`)
    ...
    const getPastaItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/pastaItem/get`)
