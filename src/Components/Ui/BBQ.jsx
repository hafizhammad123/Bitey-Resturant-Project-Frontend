...
import dealsImage from "../../assets/Images/1x/B.B.Q-01.jpg";
...
export default function Bbq() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/bbqItem/detail/${id}`)
    ...
    const getBbqItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/bbqItem/get`)
