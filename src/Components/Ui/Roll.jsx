...
import dealsImage from "../../assets/Images/1x/ROLL-01.jpg";
...
export default function Roll() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/rollItem/detail/${id}`)
    ...
    const getRollItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/rollItem/get`)
