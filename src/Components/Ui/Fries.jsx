...
import dealsImage from "../../assets/Images/1x/fries-01.jpg";
...
export default function Fries() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/friesItem/detail/${id}`)
    ...
    const getFriesItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/friesItem/get`)
