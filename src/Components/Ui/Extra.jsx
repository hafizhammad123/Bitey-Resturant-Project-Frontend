...
export default function Extra() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/extraItem/detail/${id}`)
    ...
    const getExtraItems = async () => {
        try {
            const res = await axios.get(`${BaseUrl}/extraItem/get`);
    ...
    return (
        <Container>
            ...
            <Typography textAlign={"center"} variant="h4" fontWeight={900} mb={3} mt={4}>
                Extra
            </Typography>
