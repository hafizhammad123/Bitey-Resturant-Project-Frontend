...
import dealsImage from "../../assets/Images/1x/pizzaandwich.jpg";
import { useEffect } from "react";
import axios from "axios";
import { BaseUrl } from "../util";
import DetailModal from "./DetailModal";
import { useState } from "react";
export default function PizzaSandwich() {
    ...
    const openDetailPage = async (id) => {
        ...
        try {
            const res = await axios.get(`${BaseUrl}/pizzaSandwich/detail/${id}`)
    ...
    useEffect(() => {
        getPizzaSandwichItems()
    }, [])

    const getPizzaSandwichItems = async () => {
        try {
            const getData = await axios.get(`${BaseUrl}/pizzaSandwich/get`)
